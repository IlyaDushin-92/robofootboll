...
void Joysticks() { // Левый джойстик вперед/назад. правый джойстик право/лево
  ...
  if (ps2x.Analog(PSS_LY) > 130 && ps2x.Analog(PSS_RX) < 130 && ps2x.Analog(PSS_RX) > 125){ // По оси Y > 130. Назад
  ...
  if (ps2x.Analog(PSS_LY) < 125 && ps2x.Analog(PSS_RX) < 130 && ps2x.Analog(PSS_RX) > 125){ // По оси Y < 125. Вперед
    //DCMotor_3->setSpeed(SPEED_PWM_FAST);
    //DCMotor_1->setSpeed(SPEED_PWM_FAST);
  ...
  if (ps2x.Analog(PSS_RX) > 130 && ps2x.Analog(PSS_LY) < 130 && ps2x.Analog(PSS_LY) > 125 ) { // По оси X > 128. Вправо
  ...
  if (ps2x.Analog(PSS_RX) < 125 && ps2x.Analog(PSS_LY) < 130 && ps2x.Analog(PSS_LY) > 125 ) { // По оси X > 128. Вправо
